...
import { Pool } from 'pg';
import { compileContentSnapshot, ContentValidationError } from '../../src/content/content-validator.js';
...
const main = async (): Promise<void> => {
  ...
  try {
    const result = compileContentSnapshot(await loadDeployedContentSnapshot(client));
