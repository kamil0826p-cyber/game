...
export const polishMessages = {
  ...
  'errors.group.self': 'Nie możesz zaprosić własnej postaci do grupy.',
  'errors.group.tooFar': 'Podejdź bliżej do gracza, aby zaprosić go do grupy.',
  'errors.group.participantUnavailable': 'Drugi gracz nie jest już dostępny.',
  'errors.group.alreadyMember': 'Twoja postać należy już do grupy.',
  'errors.group.targetMember': 'Ta postać należy już do grupy.',
  'errors.group.full': 'Grupa osiągnęła limit 10 osób.',
  'errors.group.inviteExists': 'Ta postać ma już aktywne zaproszenie od tej grupy.',
  'errors.group.inviteNotFound': 'To zaproszenie do grupy nie jest już dostępne.',
  'errors.group.inviteExpired': 'To zaproszenie do grupy wygasło.',
  'errors.group.required': 'Twoja postać nie należy do grupy.',
  'errors.group.forbidden': 'Tylko administrator grupy może wykonać tę akcję.',
  'errors.group.memberNotFound': 'Ta postać nie jest członkiem twojej grupy.',
  'errors.group.adminCannotKickSelf': 'Administrator nie może wyrzucić samego siebie. Zamiast tego opuść grupę.',
