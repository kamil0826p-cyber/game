...
export const polishMessages = {
  ...
  'errors.character.limitReached': 'W tym świecie możesz mieć maksymalnie pięć postaci.',
  'errors.character.notFound': 'Wybrana postać nie istnieje albo nie należy do tego konta.',
