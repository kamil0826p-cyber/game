...
import { installCraftingSocketBridge } from './craftingSocketBridge';
...
import { installRewardClaimsSocketBridge } from './rewardClaimsSocketBridge';
...
export function GameConnectionProvider({ user, children }: GameConnectionProviderProps): React.JSX.Element {
  ...
  if (!clientRef.current) {
    ...
    installRewardClaimsSocketBridge(clientRef.current);
  }
  useEffect(() => {
